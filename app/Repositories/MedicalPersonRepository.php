...
class MedicalPersonRepository
{
    ...
    {
        $profile = MedicalPerson::where('user_uuid', $userUuid)
            ->first();
    ...
    public function add($data)
    {
        ...
        $model->specialization = Arr::get($data, 'specialization');
        $model->license_number = Arr::get($data, 'license_number');
    ...
    {
        $model = MedicalPerson::findOrFail($id);
