...
use App\Repositories\MedicalPersonRepository;
use App\Repositories\RoleUserRepository;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;
use Illuminate\Support\Arr;

class MedicalPersonController extends Controller
{
    protected $repository;
    protected $roleRepository;

    public function __construct(
        MedicalPersonRepository $repository,
        ...
        try {
            ...
            if(!empty($profile)) {
                $validator = Validator::make($request->all(), [
                    ...
                    'phone'             => "sometimes|string|unique:medical_persons,phone,$userUuid,user_uuid",
            ...
            $validator = Validator::make($request->all(), [
                ...
                'phone'             => 'required|string|unique:medical_persons',
                'bio'               => 'required|string',
